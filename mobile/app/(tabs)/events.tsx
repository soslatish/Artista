  ...
  return (
    <SafeAreaView style={styles.root}>
      <View style={styles.header}>
        <Text style={styles.title}>Каталог заказов</Text>
        {user?.role === 'customer' && (
          <TouchableOpacity onPress={() => router.push('/create-event')} style={styles.addBtn}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          refreshControl={<RefreshControl refreshing={refreshing} onRefresh={fetchEvents} tintColor={COLORS.orange} />}
          ListEmptyComponent={
...
const styles = StyleSheet.create({
  ...
  searchRow: {
    ...
    borderWidth: 1, borderColor: COLORS.inputBorder, paddingHorizontal: 12,
  },
